...
# # Description: A collection of processing classes for managing the employee ratings application
# ChangeLog: (Who, When, What)
# SGhafir,12/10/2023,Created Script
# -------------------------------------------------------------------------------------- #
...
class FileProcessor:
    ...
    ChangeLog: (Who, When, What)
    SGhafir,12/10/2023,Created Class
    """
    ...
    def read_employee_data_from_file(file_name: str, employee_data: list, employee_type: Employee):
        ...
        ChangeLog: (Who, When, What)
        SGhafir,12/10/2023,Created Function
